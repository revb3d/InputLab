...
%PY_CMD% -m PyInstaller --noconfirm --windowed --name InputLab --icon InputLabLogo.ico --add-data "InputLabLogo.png;." --add-data "InputLabLogo.ico;." --add-data "assets\fonts;assets\fonts" --collect-binaries vgamepad --collect-data vgamepad app.py
if errorlevel 1 (
